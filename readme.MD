...
[Форк](https://gitlab.kant.ru/kantecom/bitrix-orm-bundle). Упростил маленько, избавился от лишних зависимостей и т.п.

Интересный пример работы Symfony + Битрикс. Но на мой взгляд, перекручено с абстракциями. 
Что не отменяет качественной работы автора оригинального пакета.
